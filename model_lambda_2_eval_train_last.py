...
from einstein.optimizer.grad_methods import adam_grad
...
if __name__ == "__main__":
    ...
    updates = adam_grad(cost, lasagne.layers.get_all_params(l_reward_formed), CLEARNING_RATE)
        ...
        for n in xrange(1500):
            ...
            if previous_cost <= cost_confidence:
                ...
                while True:
                    ...
                    if count1 > 20:
                        last_error1 = train(theano_form(critic_train_inputs1[-1], shape=(N_CBATCH, N_CTIME_STEPS, N_CINPUT_FEATURES)),
                                 theano_form(critic_train_outputs1[-1], shape=(N_CBATCH, N_CTIME_STEPS, N_CINPUT_FEATURES)))
                        print "last error: ", last_error1
                        if last_error1 < train_base_line:
                            count1 = 0
                ...
                while True:
                    ...
                    if count2 > 20:
                         last_error2 = train(theano_form(critic_train_inputs2[-1], shape=(N_CBATCH, N_CTIME_STEPS, N_CINPUT_FEATURES)),
                                 theano_form(critic_train_outputs2[-1], shape=(N_CBATCH, N_CTIME_STEPS, N_CINPUT_FEATURES)))

                         print "last error: ", last_error2
                         if last_error2 < train_base_line:
                             count2 = 0
                    else:
                        costs2 = []
    ...
    #print records
    pickle.dump(records, open("records_lambda_2_eval.p", "wb"))
    pickle.dump(records, open("real_world_sample_counts_lambda_2_eval.p", "wb"))
